...
class HBQQuantizer(MXFPQuantizer):
    ...
    def q(self, x:torch.Tensor):
        ...
        scheme_diff = l2_scaled_xg_dequant_each_scheme - xgg[..., None]
        error_in_each_scheme = scheme_diff.square().sum(dim=-2, keepdim=True).sum(dim=-3, keepdim=True) # [out_ch, num_blocks, 1, 1, num_of_scale_scheme]
        del scheme_diff
        ...
        del l2_scaled_xg_dequant_each_scheme, error_in_each_scheme, min_error_idx_scheme
