# Replication script for Figure 4(b)
# W4A8 PPL results with different target formats across block sizes
...
OUT_DIR = ROOT / "save/W4A8_format_block_size"
...
for block_size in BLOCK_SIZES:
    for act_name, qtype, act_ebit, act_mbit in ACT_FORMATS:
        ...
        if qtype == "mxfp":
            ...
            cfg["block_quant"]["act_scale_use_ceil"] = True
...
print("\nW4A8 format/block size PPL results")
print(separator)
