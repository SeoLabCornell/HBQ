...
from awq.quantize.ops import IntActWeight
...
class _QBaseLinear(nn.Linear):
    ...
    aq (_QBase): Activation quantizer.
    """
    def __init__(self, in_features: int, out_features: int, bias: bool = True, wbit:int=32, abit:int=32, train_flag=True, ops=None):
